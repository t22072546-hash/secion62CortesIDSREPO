...
<%
    ...
    String DRIVER = "com.mysql.jdbc.Driver"; // Usar el nombre de variable definido
    String URL = "jdbc:mysql://localhost:3306/pruebas"; 
    // Código Corregido para XAMPP
    String USER = "root";  
    String PASS = "";      // Deja la contraseña como cadena vacía

    // 1. Obtener los parámetros enviados por POST desde editar.jsp
    String idStr = request.getParameter("id");
    String usuario = request.getParameter("usuario");
    String clave = request.getParameter("clave");
    String rol = request.getParameter("rol"); // Recibir el rol desde el formulario
    ...
    try {
        ...
        // CORRECCIÓN 1: Usar DRIVER en lugar de DB_DRIVER
        Class.forName(DRIVER);

        // 3. Establecer la conexión
        // CORRECCIÓN 2: Usar URL, USER, PASS en lugar de DB_URL, DB_USER, DB_PASSWORD
        conn = DriverManager.getConnection(URL, USER, PASS);

        // 4. Definir la consulta SQL para actualizar (La consulta tiene 4 placeholders: usuario, clave, rol, id)
        ...
        // CORRECCIÓN 3: Asignar el valor de la variable 'rol' al tercer placeholder
        pstmt.setString(3, rol);
        // El ID va al cuarto placeholder
        pstmt.setInt(4, id); 
        ...
        if (filasAfectadas > 0) {
            exito = true;
            mensaje = "Usuario ID " + id + " actualizado con éxito. Rol: " + rol;
        } else {
        ...
        mensaje = "ERROR SQL: No se pudo actualizar el registro. Detalle: " + e.getMessage();
    } catch (Exception e) {
